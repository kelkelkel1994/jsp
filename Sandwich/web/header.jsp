            ...
            <section class="topbar">
                <div class="container">
                    <div class="top-left hidden-xs hidden-sm ">
                        <p>Chào mừng bạn đến với bigFood!</p>
                    </div>
                    <div class="top-right">
                        <ul class="list-unstyled">
                            <li class="first"><a href="index.jsp"><span>Trang chủ</span></a></li>
                            <li class=""><a href="collections/all.html"><span>Sản phẩm</span></a></li>
                            ...
                            <%}else{%>
                            <li class="last"><a href="cart.jsp"><span><%=users.getTen()%></span></a>
                                <ul class="list-unstyled top-account">
                                    <li><a href="cart.jsp"><span>Giỏ hàng</span></a></li>
                                    <li><a href="logout.jsp"><span>Thoát</span></a></li>
                                </ul>
                            </li>
                            <%}%>
                        </ul>					
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-14 cart-right">
                                                    ...
                                                    <div class="cart-price">
                                                        ...
                                                        <%=list.getValue().getProduct().getGiakm()%>₫
                                                        <%} else {%>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-sm-12 col-xs-12">
                            <div class="logo">
                                <a href="index.jsp">
                                    <img src="./images/logoefbf.jpg" title="Big Food" alt="Big Food">
                                </a>
                            </div>
                        </div>
                        <div class="hidden-xs hidden-sm col-md-9 col-xs-12">
                            <div class="static">
                                <div class="static-p">
                                    ...
                                    <p class="static-info">(04) 6674 2332</p>
                                </div>								
                                <div class="static-e">
                                    <p class="static-title">Email:</p>
                                    <p class="static-info">support@dkt.com.vn</p>
                                </div>								
                                <div class="static-t">
                                    <p class="static-title">Open:</p>
                                    <p class="static-info">8 AM - 10 PM</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="menu hidden-sm hidden-xs">
                        <ul class="list-unstyled">
                            ...
                            <li class=" sub-menu"><a href="collections/all.html"><span>Sản phẩm</span></a>
                                <ul class="list-unstyled">
