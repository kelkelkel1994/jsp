                        ...
                        <div class="col-md-9 col-md-push-3 center-site">
                            <div class="center">
                                ...
                                <div class="collect-grid">
                                    <div class="row">
                                    <%
                                        for (products p : pd.getListProductByCategory(Long.parseLong(category_id))) {
                                    %>
                                ...
                                <div class="product-grid clearfix">
                                    ...
                                    <div class="prod-info">
                                        ...
                                        <div class="action-box">
                                            <form action="index.jspcart/add" method="post">
                                                <input type="hidden" name="variantId" value="2097518" />
                                                <button type="submit" title="Mua hàng" class="list-add-cart add-to-cart">				
                                                    <span>Mua hàng</span>
                                                </button>		
                                            </form>
