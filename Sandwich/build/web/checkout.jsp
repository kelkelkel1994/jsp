...
<body class="body--custom-background-color ">   
    ...
    <form method="post" action="#" data-toggle="validator" class="formCheckout">
        <div context="checkout" define='{checkout: new Bizweb.Checkout(this,{ existCode: false, totalOrderItemPrice: 695000.0000, discount: 0, shippingFee: 0, freeShipping: false, requiresShipping: true, code: "", settingLanguage: "vi", moneyFormat: "{{amount_no_decimals_with_comma_separator}}&#8363;", discountLabel: "Miễn phí vận chuyển", districtPolicy: "optional" })}' class="container checkout">
            <div class="header">
                <div class="wrap">
                                                ...
                                                <%for (Map.Entry<Long, item> list : cart.getCartItems().entrySet()) {%>
                                                    <li class="product product-has-image clearfix">
                                                        ...
                                                        <strong class="product-price pull-right">
                                                            ...
                                                            <%=list.getValue().getProduct().getGiakm()*list.getValue().getQuantity()%>&#8363;
                                                            <%} else {%>
                                                            <%=list.getValue().getProduct().getGia()*list.getValue().getQuantity()%>&#8363;
                                                            <%}%>
                                                        </strong>
                                                    </li>
                                                <%}%>
